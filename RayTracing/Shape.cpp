...
Sphere::Sphere(vec3 i, float j) { c = i, r = j; }
bool Sphere::intersect(const Ray ray, float &t, vec3 &col) {
...
bool Plane::intersect(Ray ray, float &t, vec3 &col) {
...
bool Triangle::intersect(Ray ray, float &t, vec3 &col) {
